...
const Projects = ({ textColor, backgroundColor }) => {
  return (
    <div style={{ backgroundColor: backgroundColor, color: textColor }}className='mainContent'>
      ...
      <p>A minimalist climb-tracking app. A lot of the other apps on the market are bloated with features, and don't give you a concrete way to understand your own progression. Bould. aims to be quick and simple to use, and provide an even easier way to understand your data. Check it out backend <a rel="noopener noreferrer" target='_blank' href='https://github.com/zackmckenna/bouldServer'>here</a>, the frontend <a rel="noopener noreferrer" target='_blank' href='https://github.com/zackmckenna/bouldServerNative'>here</a>. Demo on <a rel="noopener noreferrer" target='_blank' href='https://exp.host/@zackmckenna/bould'>Expo</a>.</p>
