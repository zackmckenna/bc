  ...
  return (
    <div className='mainContent'>
      ...
      <ul>
        ...
        <li>weeks of 12+ hours in tech</li>
        <li>hundreds of shows, events and venues</li>
      ...
      <p>but what can you do as a self taught developer?</p>
      <h3>Can you do HTML and CSS?</h3>
      <p>Oh, is this too boring? click here.</p>
      <h3>What about modern libraries?</h3>
      <p>Yeah, I got that too. This is built in React.</p>
      <h3>Well, can do use third party APIs?</h3>
      <p>bingo</p>
      <h3>What about user authentication and stuff?</h3>
      <p>If you really really want to log in, you can do that here.</p>
      <h3>Can you work on a team?</h3>
      <p>Yes! But don't take my word for it, just ask for references.</p>
      <h3>Do you know how to git?</h3>
      <p>yeah, I can git</p>
      <h3>What about creating an algorithm that sorts a list of one million integers in order from least to most, with a time complexity of 1(n)?</h3>
      <p>no thank you</p>
    </div>
  )
}
